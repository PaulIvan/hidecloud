// Initialize Firebase
var config = {
	apiKey: "AIzaSyDJ0p-fX25-LkS_muYw57-O2l45qpUyxSM",
	authDomain: "hidecloud-294e7.firebaseapp.com",
	databaseURL: "https://hidecloud-294e7.firebaseio.com",
	storageBucket: "hidecloud-294e7.appspot.com",
	messagingSenderId: "26452456408"
};
firebase.initializeApp(config);

var database = firebase.database();
var cloudTracks = database.ref('/tracks');
...
cloudTracks.once('value').then(function (snapshot) {
	hiddenTracks = JSON.parse(snapshot.val());
	...
	if (jQuery) {
		...
		$(document).ready(function () {
			...
			cloudTracks.on('value', function (snapshot) {
				hiddenTracks = JSON.parse(snapshot.val());
		...
		function hideTrack(e) {
			...
			cloudTracks.set(JSON.stringify(hiddenTracks));
